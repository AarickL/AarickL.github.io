			...
			<!-- Header -->
				<div id="header-wrapper">
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="index.php">Strongly Typed</a></h1>
						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li><a class="icon fa-cog" href="left-sidebar.php"><span>Left Sidebar</span></a></li>
									<li><a class="icon fa-retweet" href="right-sidebar.php"><span>Right Sidebar</span></a></li>
									<li><a class="icon fa-sitemap" href="no-sidebar.php"><span>No Sidebar</span></a></li>
								</ul>
							</nav>
